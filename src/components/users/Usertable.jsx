        ...
        <div className='flex sm:items-center sm:flex-row flex-col justify-between mb-6'>
           <h1 className="text-xl font-semibold text-gray-100 mb-8">
            ...
            <div className='relative self-start '>
                 <input type='text' placeholder='Search users...' value={searchTerm} onChange={handleSearch} className='bg-gray-700 text-white placeholder-gray-400 rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500' />
